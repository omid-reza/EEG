...
set(gcf, "NumberTitle", false, "Name", "Sham - EO - Alpha", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\power\sham_eo\Alpha");
saveas(gcf, "result\visual\png\power\sham_eo\Alpha.png");