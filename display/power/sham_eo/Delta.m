...
set(gcf, "NumberTitle", false, "Name", "Sham - EO - Delta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\power\sham_eo\Delta");
saveas(gcf, "result\visual\png\power\sham_eo\Delta.png");