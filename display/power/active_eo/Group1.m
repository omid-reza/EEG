...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_eo\pre\Group1-Alpha.txt");
plt.y.post.group1.data=load("result\raw\power\active_eo\post\Group1-Alpha.txt");
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_eo\pre\Group1-Beta.txt");
plt.y.post.group1.data=load("result\raw\power\active_eo\post\Group1-Beta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
% Draw a plt for Beta
subplot(2, 3, 2);
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_eo\pre\Group1-Delta.txt");
plt.y.post.group1.data=load("result\raw\power\active_eo\post\Group1-Delta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_eo\pre\Group1-Gamma.txt");
plt.y.post.group1.data=load("result\raw\power\active_eo\post\Group1-Gamma.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_eo\pre\Group1-Theta.txt");
plt.y.post.group1.data=load("result\raw\power\active_eo\post\Group1-Theta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
savefig(gcf, "result\visual\fig\power\active_eo\Group1");
saveas(gcf, "result\visual\png\power\active_eo\Group1.png");