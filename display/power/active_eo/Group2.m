...
% Config plt
plt.y.pre.group2.data=load("result\raw\power\active_eo\pre\Group2-Alpha.txt");
plt.y.post.group2.data=load("result\raw\power\active_eo\post\Group2-Alpha.txt");
...
% Config plt
plt.y.pre.group2.data=load("result\raw\power\active_eo\pre\Group2-Beta.txt");
plt.y.post.group2.data=load("result\raw\power\active_eo\post\Group2-Beta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group2.data));
plt.x.post.data=ones(1, length(plt.y.post.group2.data))+1;
% Draw a plt for Beta
subplot(2, 3, 2);
...
% Config plt
plt.y.pre.group2.data=load("result\raw\power\active_eo\pre\Group2-Delta.txt");
plt.y.post.group2.data=load("result\raw\power\active_eo\post\Group2-Delta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group2.data));
plt.x.post.data=ones(1, length(plt.y.post.group2.data))+1;
...
% Config plt
plt.y.pre.group2.data=load("result\raw\power\active_eo\pre\Group2-Gamma.txt");
plt.y.post.group2.data=load("result\raw\power\active_eo\post\Group2-Gamma.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group2.data));
plt.x.post.data=ones(1, length(plt.y.post.group2.data))+1;
...
% Config plt
plt.y.pre.group2.data=load("result\raw\power\active_eo\pre\Group2-Theta.txt");
plt.y.post.group2.data=load("result\raw\power\active_eo\post\Group2-Theta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group2.data));
plt.x.post.data=ones(1, length(plt.y.post.group2.data))+1;
...
savefig(gcf, "result\visual\fig\power\active_eo\Group2");
saveas(gcf, "result\visual\png\power\active_eo\Group2.png");