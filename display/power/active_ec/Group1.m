...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_ec\pre\Group1-Delta.txt");
plt.y.post.group1.data=load("result\raw\power\active_ec\post\Group1-Delta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_ec\pre\Group1-Gamma.txt");
plt.y.post.group1.data=load("result\raw\power\active_ec\post\Group1-Gamma.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
% Config plt
plt.y.pre.group1.data=load("result\raw\power\active_ec\pre\Group1-Theta.txt");
plt.y.post.group1.data=load("result\raw\power\active_ec\post\Group1-Theta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.group1.data));
plt.x.post.data=ones(1, length(plt.y.post.group1.data))+1;
...
savefig(gcf, "result\visual\fig\power\active_ec\Group1");
saveas(gcf, "result\visual\png\power\active_ec\Group1.png");