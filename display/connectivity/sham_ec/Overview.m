...
hold on;
grid on;
plt.y.pre.data=load("result\raw\connectivity\sham_ec\pre\Alpha.txt");
plt.y.post.data=load("result\raw\connectivity\sham_ec\post\Alpha.txt");
...
hold on;
grid on;
plt.y.pre.data=load("result\raw\connectivity\sham_ec\pre\Delta.txt");
plt.y.post.data=load("result\raw\connectivity\sham_ec\post\Delta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.data));
plt.x.post.data=ones(1, length(plt.y.post.data))+1;
swarmchart(plt.x.pre.data, plt.y.pre.data, plt.dot_size, plt.y.pre.color, "filled");
swarmchart(plt.x.post.data, plt.y.post.data, plt.dot_size, plt.y.post.color, "filled");
...
hold on;
grid on;
plt.y.pre.data=load("result\raw\connectivity\sham_ec\pre\Gamma.txt");
plt.y.post.data=load("result\raw\connectivity\sham_ec\post\Gamma.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.data));
plt.x.post.data=ones(1, length(plt.y.post.data))+1;
swarmchart(plt.x.pre.data, plt.y.pre.data, plt.dot_size, plt.y.pre.color, "filled");
swarmchart(plt.x.post.data, plt.y.post.data, plt.dot_size, plt.y.post.color, "filled");
...
hold on;
grid on;
plt.y.pre.data=load("result\raw\connectivity\sham_ec\pre\Theta.txt");
plt.y.post.data=load("result\raw\connectivity\sham_ec\post\Theta.txt");
plt.x.pre.data=ones(1, length(plt.y.pre.data));
plt.x.post.data=ones(1, length(plt.y.post.data))+1;
swarmchart(plt.x.pre.data, plt.y.pre.data, plt.dot_size, plt.y.pre.color, "filled");
swarmchart(plt.x.post.data, plt.y.post.data, plt.dot_size, plt.y.post.color, "filled");
