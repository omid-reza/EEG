...
% Config plt
plt.dot_size=100;
plt.y.sham.ec.alpha.group1.pre.data=load("result\raw\amplitude\sham_ec\pre\Group1-Alpha.txt");
plt.y.sham.ec.alpha.group1.post.data=load("result\raw\amplitude\sham_ec\post\Group1-Alpha.txt");
plt.y.sham.ec.alpha.group2.pre.data=load("result\raw\amplitude\sham_ec\pre\Group2-Alpha.txt");
plt.y.sham.ec.alpha.group2.post.data=load("result\raw\amplitude\sham_ec\post\Group2-Alpha.txt");
plt.y.sham.ec.gamma.group1.pre.data=load("result\raw\amplitude\sham_ec\pre\Group1-Gamma.txt");
plt.y.sham.ec.gamma.group1.post.data=load("result\raw\amplitude\sham_ec\post\Group1-Gamma.txt");
plt.y.sham.ec.gamma.group2.pre.data=load("result\raw\amplitude\sham_ec\pre\Group2-Gamma.txt");
plt.y.sham.ec.gamma.group2.post.data=load("result\raw\amplitude\sham_ec\post\Group2-Gamma.txt");
plt.y.sham.eo.alpha.group1.pre.data=load("result\raw\amplitude\sham_eo\pre\Group1-Alpha.txt");
plt.y.sham.eo.alpha.group1.post.data=load("result\raw\amplitude\sham_eo\post\Group1-Alpha.txt");
plt.y.sham.eo.alpha.group2.pre.data=load("result\raw\amplitude\sham_eo\pre\Group2-Alpha.txt");
plt.y.sham.eo.alpha.group2.post.data=load("result\raw\amplitude\sham_eo\post\Group2-Alpha.txt");
plt.y.sham.eo.gamma.group1.pre.data=load("result\raw\amplitude\sham_eo\pre\Group1-Gamma.txt");
plt.y.sham.eo.gamma.group1.post.data=load("result\raw\amplitude\sham_eo\post\Group1-Gamma.txt");
plt.y.sham.eo.gamma.group2.pre.data=load("result\raw\amplitude\sham_eo\pre\Group2-Gamma.txt");
plt.y.sham.eo.gamma.group2.post.data=load("result\raw\amplitude\sham_eo\post\Group2-Gamma.txt");
...
ylabel("Alpha Amplitude - Sham EC", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
...
ylabel("Gamma Amplitude - Sham EC", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
xlabel("  Baseline          After Intervention", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
set(gca,'XTick',[]);
title("Network 1", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
...
ylabel("Alpha Amplitude - Sham EO", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
xlabel("  Baseline          After Intervention", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
set(gca,'XTick',[]);
title("Network 1", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
...
ylabel("Gamma Amplitude - Sham EO", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
xlabel("  Baseline          After Intervention", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
set(gca,'XTick',[]);
title("Network 1", "Color", [21 19 60].*4/1000, "FontWeight", "bold");
