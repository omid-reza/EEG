...
set(gcf, "NumberTitle", false, "Name", "Active - EC - Beta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_ec\Beta");
saveas(gcf, "result\visual\png\amplitude\active_ec\Beta.png");
