...
set(gcf, "NumberTitle", false, "Name", "Active - EC - Delta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_ec\Delta");
saveas(gcf, "result\visual\png\amplitude\active_ec\Delta.png");