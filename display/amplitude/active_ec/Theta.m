...
set(gcf, "NumberTitle", false, "Name", "Active - EC - Theta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_ec\Theta");
saveas(gcf, "result\visual\png\amplitude\active_ec\Theta.png");