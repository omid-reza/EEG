...
set(gcf, "NumberTitle", false, "Name", "Active - EC - Gamma", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_ec\Gamma");
saveas(gcf, "result\visual\png\amplitude\active_ec\Gamma.png");