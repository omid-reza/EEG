...
set(gcf, "NumberTitle", false, "Name", "Active - EO - Alpha", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_eo\Alpha");
saveas(gcf, "result\visual\png\amplitude\active_eo\Alpha.png");