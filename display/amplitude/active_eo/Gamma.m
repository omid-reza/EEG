...
set(gcf, "NumberTitle", false, "Name", "Active - EO - Gamma", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_eo\Gamma");
saveas(gcf, "result\visual\png\amplitude\active_eo\Gamma.png");