...
set(gcf, "NumberTitle", false, "Name", "Active - EO - Theta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_eo\Theta");
saveas(gcf, "result\visual\png\amplitude\active_eo\Theta.png");