...
set(gcf, "NumberTitle", false, "Name", "Active - EO - Delta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\active_eo\Delta");
saveas(gcf, "result\visual\png\amplitude\active_eo\Delta.png");