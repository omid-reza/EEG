...
set(gcf, "NumberTitle", false, "Name", "Sham - EC - Alpha", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\sham_ec\Alpha");
saveas(gcf, "result\visual\png\amplitude\sham_ec\Alpha.png");