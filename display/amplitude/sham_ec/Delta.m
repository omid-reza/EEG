...
set(gcf, "NumberTitle", false, "Name", "Sham - EC - Delta", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\sham_ec\Delta");
saveas(gcf, "result\visual\png\amplitude\sham_ec\Delta.png");