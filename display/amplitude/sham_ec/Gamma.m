...
set(gcf, "NumberTitle", false, "Name", "Sham - EC - Gamma", "WindowState", "maximized");
...
savefig(gcf, "result\visual\fig\amplitude\sham_ec\Gamma");
saveas(gcf, "result\visual\png\amplitude\sham_ec\Gamma.png");