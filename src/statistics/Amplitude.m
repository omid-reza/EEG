    ...
    for ec_eo=inputArguments.ec_eo
        for files=inputArguments.files
            for group=inputArguments.networkGroups
                pre_file=load(strcat("result\raw\amplitude\", groups, "_", ec_eo, "\pre\", group, files, ".txt"));
                post_file=load(strcat("result\raw\amplitude\", groups, "_", ec_eo, "\post\", group, files, ".txt"));
